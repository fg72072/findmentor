                                ...
                                <div class="item-content">
                                    ...
                                    <div class="listing_icons pt-5">
                                        <div class="TextIcon">
                                            ...
                                            <p>{{$item->phone_verified == 0 ? 'Not Verified' : '+92-**********'}}</p>
                                        </div>
                                    </div>
                                    <div class="listing_icons pt-5">
                                        <div class="TextIcon">
                                        ...
                                        <div class="TextIcon">
                                            ...
                                            <p>{{$item->online_class == 'yes'?'Available online':'Not Available'}}</p>
                                        </div>
                                        <div class="TextIcon">
                                    ...
                                    <div class="listing_icons pt-5">
                                        <div class="TextIcon">
                                            ...
                                            <p>{{$item->class_at_tutor_place == 'yes'?'Travel':'Can not travel'}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
