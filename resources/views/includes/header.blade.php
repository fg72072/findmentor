                            ...
                            <ul class="list-inline- up-ul allChildLinksNormal padding-left-0">
                                <li class="btn-group">
                                    <a href="{{ route('job_messages') }}">
                                        <button class="btn btn-default clsStandAloneUnreadMsgStudent" type="button"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-envelope"
                                                width="30" height="30" viewBox="0 0 128 100">
                                ...
                                <li class="btn-group">
                                    <button data-toggle="dropdown"
                                        class="btn btn-default dropdown-toggle color-light-grey" type="button"
                                        style="border:none;padding: 1px 0 0 0; /* font-size: 29px; */">
                                        <img src="https://www.teacheron.com/resources/assets/customPlugin/chatbot/images/unknown.jpg"
                                            ...
                                            <i class="fas fa-angle-down"
                                                style="width: 9.68px; display: inline-block;"></i>
                                        </span>
                                        <span class="sr-only">
                                            Toggle Dropdown
                                        </span>
            ...
            <div class="container margin-bottom-20">
                <ul class="nav navbar-nav">
                    ...
                    @if (Auth::user())
                        ...
                        <li class="dropdown">
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                Find Tutor Jobs <i class="fas fa-angle-down "
                                    style="width: 9.68px; display: inline-block;" aria-hidden="true"></i>
                            </a>
                            <ul class="dropdown-menu">
                    ...
                    @else
                        ...
                        <li><a class="goPremiumMenuLink ml-2" href="{{ route('student.request') }}">Request a
                                Tutor</a></li>
                    @endif
                </ul>
            </div>
