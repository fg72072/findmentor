                        ...
                        <ul class="list-inline- up-ul allChildLinksNormal padding-left-0">
                            ...
                            <li class="btn-group">
                                ...
                                <ul role="menu" class="dropdown-menu topbarDropdown">
                                    ...
                                    <li class="simpleText">
                                        {{ Auth::user()->name }}<br><small>{{ Auth::user()->email }}</small></li>
                                    <li>
                                        <hr>
                                    </li>
        ...
        <div class="collapse navbar-collapse mega-menu navbar-responsive-collapse margin-bottom-10">
            <div class="container margin-bottom-20">
                <ul class="nav navbar-nav">
                    ...
                    @role('student')
                    <li><a class="goPremiumMenuLink" href="{{ route('student.request') }}">Post Requirement</a></li>
                    @endrole
                    ...
                    <li><a class="goPremiumMenuLink ml-2" href="{{ route('student.request') }}">Request a Tutor</a></li>
                    @endif
                </ul>
            </div>
            <!--/end container-->
